  ...
  return (
      ...
      <div className='showcase' >
        <div className="overlay px-5 " >
            <h1 className='text-4xl font-bold text-white capitalize text-center mb-4 lg:text-6xl' > Viewing articles about {term} </h1>
      ...
      :(
        ...
        <section className='grid grid-cols-1 gap-10 px-5 pt-10 pb-20'>
          {articles.map((article) =>{
            ...
            return (
              <article key={_id} className='bg-white py-10 px-5 rounded-lg lg:w-9/12 lg:ma-auto' >
